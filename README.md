...
| --- | --- | --- | --- |
| `beta` | `dev` | `beta_user_profile`, `beta_payment`, `beta_institute_product`, `beta_monthly_report` (us-east-2) | test |
| `prod` | `prod` | `user_profile`, `payment`, `institute_product`, `monthly_report` (us-east-1) | live |
